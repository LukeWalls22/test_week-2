...
{
console.log("Array di partenza ESERCIZIO 4")
console.log(pets)

let testa = pets.shift();
let coda = pets.pop();
...
console.log(pets)
console.log("Array finale ESERCIZIO 4")
}
...
let numcas = Math.floor(Math.random()*10)
let numcas2 = Math.floor(Math.random()*10)
let numcas3 = Math.floor(Math.random()*10)

let targa = "EP" + numcas + numcas2 + numcas3 + "KV";
